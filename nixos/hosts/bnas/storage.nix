  ...
  disks = [
    {
      type = "parity";
      name = "parity0";
      #TODO uuid = "c066a6f6-ce3e-4c0b-8cff-0f7ddec867ab";
    }
    {
      type = "data";
      name = "data0";
      #TODO uuid = "ea3d18b1-ab86-4493-8b1d-ca0c041de2e3";
    }
    {
      type = "data";
      name = "data1";
      #TODO uuid = "15d705bf-4002-4e8d-82e4-a647df1e0082";
    }
    {
      type = "data";
      name = "data2";
      #TODO uuid = "fd5f8029-50fe-41b6-87b2-74f7a9f2b7ab";
    }
